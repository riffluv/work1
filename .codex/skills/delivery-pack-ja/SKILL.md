...
description: "ココナラ案件の納品物を、`00_結論と確認方法.md`・修正済みファイル（標準）または修正差分（任意）の2点を標準として作成する。正式納品前チェックと正式納品メッセージ作成を依頼されたときに使う。"
---
