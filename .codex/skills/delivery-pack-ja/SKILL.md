...
description: "ココナラ案件の納品物を、診断レポート（確認手順を含む）・修正済みファイル（標準）または修正差分（任意）の2点を標準として作成する。正式納品前チェックと正式納品メッセージ作成を依頼されたときに使う。"
---
...
2. 診断レポート（購入者向け見出しで、原因 / 修正内容 / 関係する部分 / 確認手順 / 確認結果）
