...
- Confirm the issue definition is reproducible or narrowed down with evidence.
- State what was broken, what changed, and how to verify it.
- Keep scope aligned to one bug unless an additional paid option is agreed.
