...
(async () => {
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        body {
          ...
          width: 1220px;
          height: 1016px;
          background: linear-gradient(to right, #0E1D2C, #17324B);
    ...
    <body>
      ...
      <div class="content-wrapper">
        ...
        <div class="line3">Webhook・API連携も対応</div>
      </div>
    </body>
    </html>
  `;
  ...
  await page.screenshot({ path: '/home/hr-hm/Project/work/thumbnail_coconala_bugfix.png' });
  await browser.close();
})();
