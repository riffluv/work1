...
2. `coconala-reply-bugfix-ja`
3. 送信用返信は毎回 `japanese-chat-natural-ja`
4. 必要に応じて `docs/coconala-reply-self-check.ja.md`
5. 必要に応じて `docs/writing-guideline.ja.md`
6. Stripe案内がある場合は `/home/hr-hm/Project/work/stripe日本語UI案内`
