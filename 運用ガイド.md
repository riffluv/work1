...
| `#P` | 購入後の途中報告を作りたい時 | 購入後トークルームの途中報告を作る。完了報告では使わない。 | `/home/hr-hm/Project/work/docs/next-codex-prompt.txt` / `/home/hr-hm/Project/work/docs/coconala-message-templates-short.ja.md` / `/home/hr-hm/Project/work/.codex/skills/coconala-reply-bugfix-ja/references/ui-progress-tags.ja.md` | `#P` |
