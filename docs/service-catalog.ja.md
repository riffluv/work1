...
| `handoff-25000` | 登録済み・未公開 | AI/外注コードの現状整理と引き継ぎメモ作成 | 2本目候補（整理専用） | 基本25,000円 + 追加の処理の流れ1つ15,000円 | 正本: `サービスページ/handoff-25000.ready.txt` / 回答例: `サービスページ/次期サービス候補/引き継ぎコード現状整理_トークルーム回答例.txt` |
